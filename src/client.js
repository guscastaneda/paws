...
// ── Recurring services ────────────────────────────────────────────────────────
  ...
  return jsonRes({
    ...
    altCaregiverName:         f["Alternate Caregiver Name"]         || "",
    altCaregiverPhone:        f["Alternate Caregiver Phone"]        || "",
    altCaregiverRelationship: f["Alternate Caregiver Relationship"] || "",
    emergencyInfoConfirmed:   f["Emergency Info Last Confirmed"]    || "",
    emailConfirmed:        f["Email Confirmed"]                 === true,
    agreementSigned:       f["Agreement Signed"]               === true,
    agreementSignedDate:   f["Agreement Signed Date"]          || "",
    agreementSignedName:   f["Agreement Signed Name"]          || "",
    agreementVersion:      f["Agreement Version"]              || "",
