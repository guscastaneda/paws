        ...
        <div id="edit-tab-insurance" style="display:none;">
          ...
          <div style="background:var(--surface,#FBF9F5);border:1px solid var(--line-soft,#EFEAE0);border-left:3px solid var(--green,#2F7D52);border-radius:10px;padding:0.85rem 1rem;margin-bottom:0.5rem;">
            ...
            <div style="display:flex;flex-wrap:wrap;gap:0.5rem;margin-bottom:0.6rem;">
              <a href="https://healthypaws.live/4erx4ssr" target="_blank" rel="noopener noreferrer sponsored" style="display:inline-flex;align-items:center;gap:0.3rem;font-size:0.78rem;font-weight:600;color:var(--green,#2F7D52);text-decoration:none;border:1.5px solid var(--green,#2F7D52);border-radius:999px;padding:0.4rem 0.85rem;">Healthy Paws (our pick)</a>
